      ...
      <div className="flex flex-col items-center justify-center min-h-[70vh]">
        <div className="w-full max-w-md px-4">
          ...
          <div className={titleClasses}>
            ...
            <span className="text-xl font-medium">À Nos Services</span>
          </div>
          ...
          <div 
            ...
            onMouseEnter={() => setTextBoxContent('Découvrez nos services exceptionnels adaptés à vos besoins.')}
          ...
          >
            <div className="p-4 h-full flex items-center justify-center text-gray-400 text-sm transition-opacity duration-300">
              {textBoxContent || "Passez le curseur ici pour voir plus d'informations"}
            </div>
          </div>
